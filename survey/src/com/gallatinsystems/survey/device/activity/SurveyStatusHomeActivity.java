...
/**
 * Displays a menu for going on to the different kinds of survey status: Saved
 * () Submitted (how the upload has progressed) Also displays a count for each
 * choice.
 * 
...
public class SurveyStatusHomeActivity extends Activity {
    ...
    public void onResume() {
        ...
        SavedCount.setText(Integer.toString(databaseAdapter
                .countSurveyRespondents(ConstantUtil.SAVED_STATUS)));
        SubmittedCount.setText(Integer.toString(databaseAdapter
