...
/**
 * Activity for reviewing submitted surveys. This activity allows the user to
 * delete, resend, see transmission history for and review (readonly) submitted
 * surveys Displays the current transmission status with colored icons. Single
 * touch goes to readonly review, context menu chooses between delete, resend,
 * and see history
 * 
...
public class SubmittedSurveyReviewActivity extends ListActivity {
    ...
    /**
     * loads the survey instances from the database. this will load only
     * submitted surveys.
     */
