...
class HelpActivityTest {
    ...
    @get:Rule
    var intentsTestRule: IntentsTestRule<HelpActivity> =
        object :
            IntentsTestRule<HelpActivity>(HelpActivity::class.java, false, false) {}
    ...
    fun activityShouldDisplayCorrectDataPointTitle() {
        ...
        ScreenRobot.withRobot(HelpScreenRobot::class.java)
            .provideActivityContext(intentsTestRule.activity)
            .checkTitleIs(R.string.help)
    }

    class HelpScreenRobot : ScreenRobot<HelpScreenRobot>()
}
