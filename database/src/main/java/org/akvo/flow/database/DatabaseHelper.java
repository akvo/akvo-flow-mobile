...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final int VER_FORM_INSTANCE_CURSOR = 92;
    static final int DATABASE_VERSION = VER_FORM_INSTANCE_CURSOR;
    ...
    private final FormInstanceDownloadTable formInstanceDownloadTable;

    public DatabaseHelper(Context context, LanguageTable languageTable, DataPointDownloadTable dataPointDownloadTable, FormInstanceDownloadTable formInstanceDownloadTable) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
        this.languageTable = languageTable;
        this.dataPointDownloadTable = dataPointDownloadTable;
        this.formInstanceDownloadTable = formInstanceDownloadTable;
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        formInstanceDownloadTable.onCreate(db);
        createIndexes(db);
    }
    ...
    public void upgradeFromDataPointStatus(@NotNull SQLiteDatabase db) {
        formInstanceDownloadTable.onCreate(db);
    }
    /**
