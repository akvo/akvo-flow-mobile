 ...
 */
public class PhotoQuestionViewImpl extends QuestionView implements
        TimedLocationListener.Listener, MediaSyncTask.DownloadListener, PhotoQuestionView {
    ...
    public PhotoQuestionViewImpl(Context context, Question q, SurveyListener surveyListener) {
