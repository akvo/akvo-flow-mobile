...
public class GeoShapeConstants {
    ...
    public static final String UNSELECTED_POINT_LAYER_ID = "unselected-point-layer-id";
    ...
    public static final int UNSELECTED_POINT_COLOR = 0xFF736357;
    public static final int UNSELECTED_POINT_LINE_COLOR = 0xFF5B5048;
