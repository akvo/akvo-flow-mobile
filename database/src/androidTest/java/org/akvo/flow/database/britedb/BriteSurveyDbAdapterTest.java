...
public class BriteSurveyDbAdapterTest {
    ...
    @Before
    public void setUp() {
        DatabaseHelper databaseHelper = new DatabaseHelper(InstrumentationRegistry.getInstrumentation().getTargetContext(), new LanguageTable(), new DataPointDownloadTable(), new FormUpdateNotifiedTable());
